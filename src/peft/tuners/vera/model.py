...
class VeraModel(LoraModel):
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        if not isinstance(target, VeraLayer):
    ...
    def _create_new_module(lora_config, adapter_name, target, **kwargs):
        ...
        if loaded_in_8bit and isinstance(target_base_layer, bnb.nn.Linear8bitLt):
            ...
            new_module = VeraLinear8bitLt(target, adapter_name, **kwargs)
            ...
            new_module = VeraLinear4bit(target, adapter_name, **fourbit_kwargs)
        elif AutoGPTQQuantLinear is not None and isinstance(target, AutoGPTQQuantLinear):
            new_module = VeraQuantLinear(target, adapter_name, **kwargs)
        else:
            ...
            new_module = VeraLinear(target, adapter_name, **kwargs)
    ...
    def _prepare_adapter_config(peft_config, model_config):
        if peft_config.target_modules is None:
            ...
            peft_config.target_modules = TRANSFORMERS_MODELS_TO_VERA_TARGET_MODULES_MAPPING[
